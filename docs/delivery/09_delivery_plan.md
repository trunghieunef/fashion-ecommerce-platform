...
B1 · 2026-09-19 · Owner: TL + PO · Lịch là dự báo, chưa gán tên người hoặc sprint thật.
...
Phase 0 dự kiến 2–3 tuần; Phase 1 thêm 6–8 tuần; Phase 2 thêm 4–6 tuần. Không gắn tuần với ngày lịch khi O08 chưa chốt. Estimate trong 10 là person-day làm việc tập trung, bao gồm code/test/doc, chưa cộng chờ sandbox/review.
...
- Với vertical slice: FE/admin tích hợp và demo staging; không đánh dấu hoàn tất chỉ vì backend unit test.
